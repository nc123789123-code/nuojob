    ...
    <div className="min-h-screen bg-[#f8fafb] flex items-center justify-center px-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center">
          ...
          <p className="text-sm text-[#2b3138]">Subscriber stats</p>
        </div>

        {!stats && (
          <form onSubmit={submit} className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
            <div>
              <label className="block text-xs font-medium text-[#1a1e24] mb-1">Admin token</label>
              <input
                type="password"
                value={token}
