  ...
  return (
    <div className="min-h-screen bg-[#201B2E]" style={{ fontFamily: "'Nunito', sans-serif" }}>
      ...
      <div className="max-w-lg mx-auto px-5 py-16 text-center">
        <div className="w-16 h-16 bg-[#14352A] border-2 border-[#38324E] rounded-full flex items-center justify-center mx-auto mb-6">
        ...
        {/* Calendly embed */}
        {calendlyUrl ? (
          <div className="bg-[#201B2E] rounded-2xl border border-[#38324E] overflow-hidden shadow-sm mb-8">
            <iframe
          ...
          <div className="bg-[#201B2E] rounded-2xl border border-[#38324E] px-6 py-10 mb-8">
        ...
        <div className="bg-[#201B2E] rounded-xl border border-[#38324E] p-5 text-left mb-6">
