  ...
  return (
    <section id="guide" className="bg-[#eef6f2] border-t border-[#c1d9ce]/50 py-16 px-5">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Intro */}
        <p className="text-[#1a1e24] text-sm leading-relaxed max-w-xl mb-2">
          Most candidates know where to apply. Few know how to pass.
        </p>
        <p className="text-[#1a1e24] text-sm leading-relaxed max-w-xl mb-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
            ...
            <div className="sm:text-right flex-shrink-0">
              <div className="flex items-baseline gap-2 mb-1">
                <span className="text-[#2b3138] text-lg line-through font-normal">$25</span>
                <span className="text-[#191c1e] text-3xl font-bold">$10</span>
              </div>
              <div className="text-[#2b3138] text-xs mb-5">one-time · instant access</div>
        ...
        {/* Trust note */}
        <p className="text-[#2b3138] text-xs text-center">
