  ...
  return (
    <section id="guide" className="bg-[#eef6f2] border-t border-[#c1d9ce]/50 py-16 px-5">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Section label */}
        <p className="text-[11px] font-semibold text-[#E9C989] uppercase tracking-widest mb-4">
          Paid Resource
        </p>

        {/* Headline */}
        <h2 className="text-[#F4F0FA] text-2xl sm:text-3xl font-bold tracking-tight mb-4">
          Turn Interviews Into Offers
        </h2>

        {/* Intro */}
        <p className="text-[#B8B0C8] text-sm leading-relaxed max-w-xl mb-2">
          Most candidates know where to apply. Few know how to pass.
        </p>
        <p className="text-[#B8B0C8] text-sm leading-relaxed max-w-xl mb-8">
        ...
        <div className="bg-[#14101E] border border-[#c1d9ce]/60 rounded-2xl p-7 mb-8 shadow-sm">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
            <div className="flex-1">
              ...
              <h3 className="text-[#F4F0FA] text-lg font-semibold mb-4">
              ...
              <ul className="space-y-2.5">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2.5 text-[#B8B0C8] text-sm">
                    <span className="text-[#E9C989] font-bold mt-0.5 flex-shrink-0">✓</span>
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <div className="sm:text-right flex-shrink-0">
              <div className="flex items-baseline gap-2 mb-1">
                <span className="text-[#9A93AC] text-lg line-through font-normal">$25</span>
                <span className="text-[#F4F0FA] text-3xl font-bold">$10</span>
              </div>
              <div className="text-[#9A93AC] text-xs mb-5">one-time · instant access</div>

              <button
                onClick={handleGetGuide}
                disabled={checkoutLoading}
                className="w-full sm:w-auto px-6 py-3 bg-[#171226] text-white text-sm font-bold rounded-lg hover:bg-[#6D28D9] transition-colors disabled:opacity-50 mb-2 block sm:inline-block"
              >
              ...
              <button
                ...
                className="w-full sm:w-auto px-6 py-3 bg-transparent border border-[#c1d9ce] text-[#A78BFA] text-sm font-medium rounded-lg hover:border-[#6aab8e] hover:text-[#2d5162] transition-colors block sm:inline-block"
              >
                View Sample
              </button>
        ...
        {/* Trust note */}
        <p className="text-[#9A93AC] text-xs text-center">
