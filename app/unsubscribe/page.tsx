        ...
        <div className="max-w-md text-center">
          {status === "success" && (
            <>
              ...
              <h1 className="text-[#F4F0FA] text-xl font-bold mb-3">You've been unsubscribed.</h1>
          ...
          {status === "error" && (
            <>
              <h1 className="text-[#F4F0FA] text-xl font-bold mb-3">Something went wrong.</h1>
              <p className="text-[#B8B0C8] text-sm leading-relaxed">
                We couldn't process your unsubscribe request. Please email{" "}
                <a href="mailto:info@onluintel.com" className="text-[#A78BFA] hover:underline">
                  info@onluintel.com
                </a>{" "}
          ...
          {status === "missing" && (
            <>
              <h1 className="text-[#F4F0FA] text-xl font-bold mb-3">Invalid link.</h1>
              <p className="text-[#B8B0C8] text-sm leading-relaxed">
          ...
          <a href="/" className="inline-block mt-8 text-xs text-[#9A93AC] hover:text-[#F4F0FA] transition-colors">
            ← Back to Onlu
          </a>
        </div>
      </main>
