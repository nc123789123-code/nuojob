  ...
  const tocRows = toc.map((r, i) => `
    <tr>
      ...
      <td style="padding:10px 12px;border-bottom:1px solid #e5e7eb;border-left:2px solid ${i % 2 === 0 ? navy : teal}">
        ...
        <div style="font-size:11px;color:#9A93AC">${r.desc}</div>
      </td>
    </tr>`).join("");
...
<div style="max-width:620px;margin:32px auto;background:#201B2E;border-radius:12px;border:1px solid #e5e7eb;overflow:hidden">
  ...
  <div style="padding:24px 28px 0">
    <p style="margin:0;font-size:14px;color:#B8B0C8;line-height:1.7">
  ...
  <!-- TOC -->
  <div style="padding:24px 28px 0">
    <div style="font-size:10px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#8A8398;margin-bottom:10px">What's in the full guide</div>
  ...
  <div style="margin:16px 28px 0;padding:14px 18px;background:${light};border:1px solid #c8dfe8;border-radius:8px;text-align:center">
    ...
    <span style="font-size:13px;color:#8A8398;margin:0 12px">|</span>
      ...
      <tr>
        <td style="width:50%;vertical-align:top;padding-right:6px">
          <div style="border:1px solid #e5e7eb;border-radius:8px;padding:14px">
            ...
            <table style="width:100%;border-collapse:collapse">
              <tr><td style="font-size:11px;color:#9A93AC;padding:5px 0;border-bottom:1px solid #f3f4f6">SaaS / Recurring Revenue</td><td style="font-size:12px;font-weight:700;color:#15803d;text-align:right;padding:5px 0;border-bottom:1px solid #f3f4f6">6–7×</td></tr>
              <tr><td style="font-size:11px;color:#9A93AC;padding:5px 0;border-bottom:1px solid #f3f4f6">Healthcare / Defensive</td><td style="font-size:12px;font-weight:700;color:#0369a1;text-align:right;padding:5px 0;border-bottom:1px solid #f3f4f6">4–5×</td></tr>
              <tr><td style="font-size:11px;color:#9A93AC;padding:5px 0;border-bottom:1px solid #f3f4f6">Industrial / Manufacturing</td><td style="font-size:12px;font-weight:700;color:#d97706;text-align:right;padding:5px 0;border-bottom:1px solid #f3f4f6">3–4×</td></tr>
              <tr><td style="font-size:11px;color:#9A93AC;padding:5px 0">Retail / Cyclical</td><td style="font-size:12px;font-weight:700;color:#dc2626;text-align:right;padding:5px 0">2–3×</td></tr>
            </table>
          </div>
        </td>
        <td style="width:50%;vertical-align:top;padding-left:6px">
          <div style="border:2px solid ${teal};border-radius:8px;padding:14px;background:#f0f9ff">
            ...
            <p style="margin:0 0 8px;font-size:11px;font-style:italic;color:#B8B0C8">Q: Leverage = 5×, Coverage = 5×. What's the interest rate?</p>
  ...
  <div style="margin:14px 28px 0;padding:14px 18px;background:${light};border:1px solid #c8dfe8;border-radius:8px;text-align:center">
    ...
    <span style="font-size:12px;color:#9A93AC;margin-left:8px">→ Healthier than simple coverage</span>
  </div>
      ...
      <tr>
        <td style="width:50%;vertical-align:top;padding-right:6px">
          <div style="border:1px solid #e5e7eb;border-radius:8px;padding:14px">
            ...
            <table style="width:100%;border-collapse:collapse">
              <tr><td style="font-size:11px;color:#9A93AC;padding:5px 0;border-bottom:1px solid #f3f4f6">EBITDA</td><td style="font-size:11px;color:#9A93AC;text-align:right;padding:5px 0;border-bottom:1px solid #f3f4f6">150</td></tr>
              <tr><td style="font-size:11px;color:#9A93AC;padding:5px 0;border-bottom:1px solid #f3f4f6">– Capital Expenditures</td><td style="font-size:11px;color:#9A93AC;text-align:right;padding:5px 0;border-bottom:1px solid #f3f4f6">(40)</td></tr>
              <tr><td style="font-size:11px;color:#9A93AC;padding:5px 0;border-bottom:1px solid #f3f4f6">– Cash Taxes</td><td style="font-size:11px;color:#9A93AC;text-align:right;padding:5px 0;border-bottom:1px solid #f3f4f6">(20)</td></tr>
              ...
              <tr><td style="font-size:11px;color:#9A93AC;padding:5px 0;border-bottom:1px solid #f3f4f6">Cash Interest</td><td style="font-size:11px;color:#9A93AC;text-align:right;padding:5px 0;border-bottom:1px solid #f3f4f6">(60)</td></tr>
              <tr><td style="font-size:11px;color:#9A93AC;padding:5px 0;border-bottom:1px solid #f3f4f6">+ Required Principal</td><td style="font-size:11px;color:#9A93AC;text-align:right;padding:5px 0;border-bottom:1px solid #f3f4f6">(20)</td></tr>
  ...
  <div style="padding:28px;margin-top:8px;text-align:center;border-top:1px solid #f3f4f6">
    <p style="margin:0 0 16px;font-size:14px;color:#B8B0C8;line-height:1.6">
    ...
    <p style="margin:12px 0 0;font-size:11px;color:#8A8398">Onlu Intelligence · Credit Interview Guide</p>
  </div>
