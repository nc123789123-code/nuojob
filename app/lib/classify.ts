...
const STRATEGY_PATTERNS: Array<[RegExp, string]> = [
  [/\b(private credit|direct lend|leveraged finance|lev fin|unitranche|loan origination|private debt|middle market credit|first lien|second lien|subordinated debt|mezzanine|mezz|sponsor finance|credit fund|opportunistic credit|illiquid credit|alternative credit|portfolio monitor|loan monitor|credit underwrit|debt underwrit)\b/i, "private_credit"],
