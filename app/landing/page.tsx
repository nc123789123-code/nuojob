    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="bg-gradient-to-b from-[#f8fafb] to-white border-b border-[#c1c7cc]/30">
        <div className="max-w-5xl mx-auto px-4 py-16 sm:py-24">
          ...
          <p className="text-[#2b3138] text-base sm:text-lg max-w-2xl leading-relaxed mb-8">
          ...
          <div className="max-w-lg mb-10">
            <EmailCapture />
            <p className="text-gray-600 text-xs mt-2">Free bi-weekly digest · No spam · Unsubscribe anytime</p>
          </div>
            ...
            {[
              ...
              return (
                <div key={label} className={`rounded-xl px-4 py-3 border ${c.bg} ${c.border}`}>
                  ...
                  <p className="text-xs text-[#2b3138] mt-0.5">{label}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="max-w-5xl mx-auto px-4 py-14 sm:py-16">
        <div className="grid sm:grid-cols-2 gap-10 items-start">
          <div className="bg-[#fafafa] rounded-2xl border border-[#c1c7cc]/40 p-6">
            <p className="text-xs font-bold uppercase tracking-widest text-[#2b3138] mb-3">The problem</p>
            ...
            <div className="space-y-2.5">
              {[
                ...
                <div key={p} className="flex items-start gap-2.5 text-sm text-[#2b3138]">
          ...
          <div className={`rounded-2xl border p-6 ${TABS.hiring.bg} ${TABS.hiring.border}`}>
            ...
            <div className="space-y-2.5">
              {[
                ...
                <div key={p} className="flex items-start gap-2.5 text-sm text-[#1a1e24]">
      ...
      <section className="border-t border-[#c1c7cc]/30 bg-[#f8fafb]">
        <div className="max-w-5xl mx-auto px-4 py-14 sm:py-16">
          <div className="text-center mb-10">
            <p className="text-xs font-bold uppercase tracking-widest text-[#2b3138] mb-2">Five tools, one platform</p>
            ...
            {[
              ...
              return (
                <div key={tab} className={`rounded-2xl border p-5 flex flex-col ${c.bg} ${c.border}`}>
                  ...
                  <p className="text-sm text-[#2b3138] leading-relaxed mb-3 flex-1">{desc}</p>
                  <ul className="space-y-1 mb-4">
                    {points.map(p => (
                      <li key={p} className="flex items-start gap-2 text-xs text-[#1a1e24]">
      ...
      <section className="bg-white border-t border-[#c1c7cc]/30">
        <div className="max-w-5xl mx-auto px-4 py-14 sm:py-16">
          <div className="text-center mb-10">
            <p className="text-xs font-bold uppercase tracking-widest text-[#2b3138] mb-2">How it works</p>
              ...
              return (
                <div key={n} className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#2b3138] leading-relaxed">{desc}</p>
                  </div>
                </div>
              );
            })}
        ...
        <div className={`${TABS.pulse.bg}`}>
          <div className="max-w-5xl mx-auto px-4 py-8 flex flex-col sm:flex-row items-start sm:items-center gap-5">
            <div className="flex-1">
              ...
              <p className="text-sm text-[#2b3138]">Who&apos;s actively hiring, which funds raised capital, and roles worth applying to — updated every week.</p>
            </div>
            <Link href="/this-week"
      ...
      <section className="max-w-5xl mx-auto px-4 py-14 sm:py-16 text-center">
        ...
        <p className="text-[#2b3138] text-base mb-8 max-w-xl mx-auto">
        ...
        <Link href="/" className="text-[#2b3138] text-sm hover:text-[#191c1e] transition-colors">
      ...
      <footer className="border-t border-[#c1c7cc]/30 bg-[#f8fafb]">
        <div className="max-w-5xl mx-auto px-4 py-6 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex gap-4 text-xs text-[#2b3138]">
