  ...
  return (
    <div className="min-h-screen bg-[#14101E] flex flex-col">
      ...
      <main className="flex-1 max-w-2xl mx-auto px-5 py-14 w-full">
        ...
        <h1 className="text-[#F4F0FA] text-2xl font-bold tracking-tight mb-2">Terms of Service</h1>
        ...
        <div className="space-y-8 text-sm text-[#B8B0C8] leading-relaxed">
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">3. Eligibility</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">4. Permitted Use</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">5. Paid Products</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">6. No Investment Advice</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">7. Data Accuracy</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">8. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">9. Disclaimer of Warranties</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">10. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">11. Termination</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">12. Governing Law</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">13. Contact</h2>
