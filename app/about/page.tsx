    ...
    <div className="min-h-screen bg-[#f7f9fb] flex flex-col" style={{ fontFamily: "'Nunito', sans-serif" }}>
      ...
      <main className="flex-1 w-full">
        ...
        <div className="max-w-2xl mx-auto px-5 py-16 space-y-16">
          ...
          {/* Thesis */}
          <div className="space-y-4 text-[#1a1e24] text-sm leading-relaxed">
          ...
          {/* Features */}
          <div>
            <p className="text-[11px] font-bold text-[#2b3138] uppercase tracking-widest mb-6">What&apos;s on the platform</p>
          ...
          {/* Who it's for */}
          <div>
            <p className="text-[11px] font-bold text-[#2b3138] uppercase tracking-widest mb-5">Who it&apos;s for</p>
          ...
          <div className="bg-[#eef6f0] border border-[#c6e8d4] rounded-2xl px-6 py-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-[#1a1e24] text-sm">Hiring signals, market intel, and interview prep — all in one place.</p>
            </div>
            <Link href="/"
