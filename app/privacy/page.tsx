  ...
  return (
    <div className="min-h-screen bg-[#14101E] flex flex-col">
      ...
      <main className="flex-1 max-w-2xl mx-auto px-5 py-14 w-full">
        ...
        <h1 className="text-[#F4F0FA] text-2xl font-bold tracking-tight mb-2">Privacy Policy</h1>
        <p className="text-xs text-[#9A93AC] mb-10">Last updated: April 2026</p>

        <div className="space-y-8 text-sm text-[#B8B0C8] leading-relaxed">

          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">1. Overview</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">2. Information We Collect</h2>
            <p className="mb-2">We collect only what is necessary to provide the Service:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li><span className="font-medium text-[#F4F0FA]">Email address</span> — when you subscribe to our newsletter, sign up for alerts, or register for Onlu Table events</li>
              <li><span className="font-medium text-[#F4F0FA]">Payment information</span> — when you purchase a product (processed by Stripe; we do not store card details)</li>
              <li><span className="font-medium text-[#F4F0FA]">Usage data</span> — basic analytics such as page views and feature interactions, collected in aggregate and not linked to your identity</li>
              <li><span className="font-medium text-[#F4F0FA]">Communications</span> — if you contact us via email or the contact form, we retain that correspondence</li>
            </ul>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">3. How We Use Your Information</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">4. Third-Party Services</h2>
            <p className="mb-2">We use the following third-party services to operate the platform:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li><span className="font-medium text-[#F4F0FA]">Stripe</span> — payment processing. Governed by <a href="https://stripe.com/privacy" className="text-[#A78BFA] hover:underline" target="_blank" rel="noopener noreferrer">Stripe's Privacy Policy</a></li>
              <li><span className="font-medium text-[#F4F0FA]">Resend</span> — transactional and newsletter email delivery</li>
              <li><span className="font-medium text-[#F4F0FA]">Vercel</span> — hosting and infrastructure</li>
              <li><span className="font-medium text-[#F4F0FA]">Anthropic</span> — AI-generated content (firm prep guides, concept answers, market snapshots). User search queries are sent to Anthropic's API; no account data or email is included</li>
              <li><span className="font-medium text-[#F4F0FA]">RapidAPI / external data providers</span> — job listing and market data aggregation (no personal data shared)</li>
            </ul>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">5. Cookies and Local Storage</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">6. Data Retention</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">7. Your Rights</h2>
            ...
            <p className="mt-2">To exercise any of these rights, contact us at <a href="mailto:info@onluintel.com" className="text-[#A78BFA] hover:underline">info@onluintel.com</a>. We will respond within 30 days.</p>
          </section>

          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">8. Data Security</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">9. Children's Privacy</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">10. Changes to This Policy</h2>
          ...
          <section>
            <h2 className="text-[#F4F0FA] font-semibold text-base mb-2">11. Contact</h2>
            <p>For any privacy-related questions or requests, contact us at{" "}
              <a href="mailto:info@onluintel.com" className="text-[#A78BFA] hover:underline">info@onluintel.com</a>.
            </p>
          </section>
