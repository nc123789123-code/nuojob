  ...
  return (
    <div className="min-h-screen bg-[#14101E]" style={{ fontFamily: "'Nunito', sans-serif" }}>
      ...
      <div className="max-w-lg mx-auto px-5 py-16 text-center">
        ...
        <h1 className="text-2xl font-bold text-[#F4F0FA] mb-3">Keep Onlu free.</h1>
        <p className="text-sm text-[#9A93AC] leading-relaxed mb-10 max-w-sm mx-auto">
        ...
        <div className="bg-[#14101E] border border-[#2A2438] rounded-2xl p-6 text-left space-y-5">
          ...
          <div>
            <label className="block text-xs font-semibold text-[#9A93AC] mb-1.5">Or enter a custom amount</label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-sm text-[#8A8398] font-semibold">$</span>
              <input
                type="number"
                min="1"
                step="1"
          ...
          <button onClick={donate} disabled={loading}
            className="w-full py-3 bg-[#7C3AED] text-white text-sm font-bold rounded-xl hover:bg-[#171226] disabled:opacity-50 transition-colors flex items-center justify-center gap-2">
            {loading
        ...
        <div className="mt-8 bg-[#14101E] border border-[#2A2438] rounded-xl p-5 text-left">
          ...
          <ul className="space-y-2">
            {[
              ...
              <li key={item} className="flex items-start gap-2 text-xs text-[#9A93AC]">
